 ...
 const Template = ({title, desc1, desc2, image, formtype, setIsLoggedIn}) => {
  return (
    ...
    <div className='w-11/12 max-w-[450px]'>
        ...
        <p className='text=[1.125rem leading-625rem] mt-4'>
            <span
    ...
    <div className='relative w-11/12 max-[450px]'>
     
        <img src={frameImage} alt='pattern' width={450}
        height={500} loading='lazy'
        className='absolute -top-1 right-2'
        />

        <img src={image} alt='Students' width={450}
        height={450} loading='lazy'
            className='absolute -top-6 right-5 rounded-sm'
        />
    </div>
    </div>
  )
